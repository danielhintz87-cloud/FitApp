...
enum class CornerRadius {
    SHARP, SMALL, MEDIUM, LARGE, EXTRA_LARGE
}
...
object ThemePresets {
    ...
    val FITNES_POWERHOUSE = CustomTheme(
    ...
    val PROFESSIONAL_ATHLETE = CustomTheme(
    ...
    val BEGINNER_FRIENDLY = CustomTheme(
    ...
    val OLED_OPTIMIZED = CustomTheme(
...
fun CustomTheme.toShapes(): Shapes {
    val cornerSize = when (cornerRadius) {
...
private fun Color.toHsl(): FloatArray {
    ...
    val saturation = if (diff == 0f) 0f else {
