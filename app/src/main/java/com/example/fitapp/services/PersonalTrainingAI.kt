 ...
 */
@Singleton
class PersonalTrainingAI @Inject constructor(
    ...
    suspend fun analyzeFormFeedback(exercise: String, performance: String): String {
        return "Gute Ausführung beim $exercise. $performance"
    }
    
    suspend fun suggestRestTime(exercise: String, setNumber: Int): Long {
        return when {
