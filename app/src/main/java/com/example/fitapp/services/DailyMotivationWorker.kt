...
class DailyMotivationWorker(
    ...
    private suspend fun showDailyMotivation(repository: PersonalMotivationRepository) {
        ...
        val stats = SmartNotificationManager.PersonalStats(
    ...
    companion object {
        ...
        fun scheduleWork(context: Context) {
            ...
            val workRequest = PeriodicWorkRequestBuilder<DailyMotivationWorker>(
                1, TimeUnit.DAYS
            )
        ...
        private fun calculateInitialDelay(): Long {
            ...
            val minutesUntilTarget = if (now.isBefore(target)) {
