...
class ProgressiveOverloadManager(private val context: Context) {
    ...
    suspend fun calculateIntelligentProgression(
        ...
        return try {
            ...
            when {
                ...
                readinessScore > 0.8f ->
                    calculateAggressiveProgression(
                        currentWeight,
                        currentReps,
                        currentSets,
                        historicalData,
                ...
                readinessScore > 0.4f -> calculateConservativeProgression(currentWeight, currentReps, currentSets)
                    ...
                    ProgressionRecommendation.maintain(
                        ...
                        currentReps,
                        currentSets,
                        "Form oder RPE zu niedrig für Progression",
                    )
            }
        } catch (e: Exception) {
    ...
    // Helper methods
    private suspend fun getHistoricalProgressionData(
        userId: String,
        exerciseId: String,
    ): HistoricalProgressionData {
    ...
    private suspend fun getRecentPerformanceMetrics(
        userId: String,
        exerciseId: String,
    ): PerformanceMetrics {
    ...
    private fun calculateDeloadPercentage(
        fatigueScore: Float,
    ...
    private fun generateDeloadActions(
        fatigueScore: Float,
        plateauPercentage: Float,
    ): List<String> {
    ...
    private fun getCurrentExerciseMetrics(
        userId: String,
        exerciseId: String,
    ): ExerciseMetrics {
    ...
    private fun getNextProgressionStep(
