...
object ShoppingListSorter {
     ...
     */
    private val supermarketLayout = mapOf(
        // Entrance area
        "Obst & Gemüse" to 1,
    ...
    private fun sortBySupermarketLayout(items: List<ShoppingListManager.ShoppingListItem>): Map<String, List<ShoppingListManager.ShoppingListItem>> {
        return items
    ...
    private fun sortAlphabetically(items: List<ShoppingListManager.ShoppingListItem>): Map<String, List<ShoppingListManager.ShoppingListItem>> {
    ...
    private fun sortByCategoryAlphabetical(items: List<ShoppingListManager.ShoppingListItem>): Map<String, List<ShoppingListManager.ShoppingListItem>> {
        return items
            .groupBy { categorizeIngredient(it.name) }
    ...
    private fun sortByPriority(items: List<ShoppingListManager.ShoppingListItem>): Map<String, List<ShoppingListManager.ShoppingListItem>> {
    ...
    private fun sortByRecentlyAdded(items: List<ShoppingListManager.ShoppingListItem>): Map<String, List<ShoppingListManager.ShoppingListItem>> {
        val sorted = items.sortedWith(
            compareBy<ShoppingListManager.ShoppingListItem> { it.isPurchased }
    ...
    private fun sortByStatus(items: List<ShoppingListManager.ShoppingListItem>): Map<String, List<ShoppingListManager.ShoppingListItem>> {
