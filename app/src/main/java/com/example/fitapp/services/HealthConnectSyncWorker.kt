    ...
    private suspend fun saveStepsData(healthData: com.example.fitapp.network.healthconnect.HealthSyncData) {
        try {
            ...
            if (existing != null) {
                ...
                val stepsEntity =
                    com.example.fitapp.data.db.HealthStepsEntity(
                        date = dateStr,
                        steps = healthData.steps,
        ...
        try {
            ...
            healthData.exerciseSessions.forEach { exercise ->
                ...
                if (existing == null) {
                    ...
                    val exerciseEntity =
                        com.example.fitapp.data.db.HealthExerciseSessionEntity(
                            sessionId = sessionId,
                            date = dateStr,
        ...
        try {
            ...
            if (healthData.activeCalories > 0) {
                ...
                if (existing != null) {
                    ...
                    val calorieEntity =
                        com.example.fitapp.data.db.HealthCalorieEntity(
                            date = dateStr,
                            calories = healthData.activeCalories,
                            calorieType = "active",
                            source = "health_connect",
        ...
        try {
            ...
            heartRateDataList.forEach { heartRateData ->
                ...
                if (existing == null) {
                    ...
                    val heartRateEntity =
                        com.example.fitapp.data.db.HealthHeartRateEntity(
        ...
        try {
            ...
            sleepDataList.forEach { sleepData ->
                ...
                if (existing == null) {
                    ...
                    val sleepEntity =
                        com.example.fitapp.data.db.HealthSleepEntity(
                            date = dateStr,
