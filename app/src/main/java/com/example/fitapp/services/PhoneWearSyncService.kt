    ...
    private fun sendWorkoutStateToWatch(state: WearWorkoutState) {
        scope.launch {
            try {
                ...
                val request =
                    PutDataMapRequest.create(WearDataPaths.WORKOUT_STATE).apply {
    ...
    fun sendProgressDataToWatch(progressData: WearProgressData) {
        scope.launch {
            try {
                ...
                val request =
                    PutDataMapRequest.create(WearDataPaths.PROGRESS_DATA).apply {
    ...
    fun sendNotificationsToWatch(notifications: List<WearNotification>) {
        scope.launch {
            try {
                ...
                val request =
                    PutDataMapRequest.create(WearDataPaths.NOTIFICATIONS).apply {
