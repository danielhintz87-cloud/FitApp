...
object BMICalculator {
     ...
     * @return BMI value
     */
    fun calculateBMIImperial(heightFeet: Int, heightInches: Int, weightLbs: Float): Float {
     ...
     */
    fun getRecommendedWeightLoss(heightCm: Float, weightKg: Float): Float? {
     ...
     */
    fun getWeightLossTimeline(currentWeight: Float, targetWeight: Float): WeightLossTimeline {
     ...
     */
    fun calculateDailyCalorieDeficit(weightLossKg: Float, timeframeWeeks: Int): Int {
        val totalCalories = weightLossKg * 7700f
        val dailyDeficit = totalCalories / (timeframeWeeks * 7)
        return dailyDeficit.toInt()
    }
    
    private fun generateMilestones(startWeight: Float, targetWeight: Float, weeks: Int): List<WeightMilestone> {
...
object BMIAnalyzer {
    ...
    fun analyzeCompleteHealth(
        ...
        val timeline = recommendedWeightLoss?.let { loss ->
            BMICalculator.getWeightLossTimeline(weightKg, weightKg - loss)
        }
        
        val dailyCalorieDeficit = recommendedWeightLoss?.let { loss ->
