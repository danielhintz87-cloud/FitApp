...
object WeightLossAchievements {
    ...
    val FIRST_KG_LOST = PersonalAchievementEntity(
    ...
    val FIVE_KG_MILESTONE = PersonalAchievementEntity(
    ...
    val TEN_KG_MILESTONE = PersonalAchievementEntity(
        title = "10kg Champion",
    ...
    val TWENTY_KG_MILESTONE = PersonalAchievementEntity(
        title = "20kg Held",
    ...
    val BMI_NORMAL_REACHED = PersonalAchievementEntity(
    ...
    val BMI_IMPROVED = PersonalAchievementEntity(
    ...
    val SUGAR_FREE_WEEK = PersonalAchievementEntity(
        title = "Zuckerfrei",
    ...
    val PORTION_CONTROL_MASTER = PersonalAchievementEntity(
    ...
    val HYDRATION_HERO = PersonalAchievementEntity(
    ...
    val VEGETABLE_CHAMPION = PersonalAchievementEntity(
    ...
    val MINDFUL_EATING_STREAK = PersonalAchievementEntity(
    ...
    val CALORIE_STREAK_WEEK = PersonalAchievementEntity(
    ...
    val CALORIE_STREAK_MONTH = PersonalAchievementEntity(
    ...
    val WEIGHT_LOGGING_CONSISTENT = PersonalAchievementEntity(
    ...
    val FIRST_PROGRESS_PHOTO = PersonalAchievementEntity(
    ...
    val MONTHLY_PROGRESS_PHOTOS = PersonalAchievementEntity(
    ...
    val EXERCISE_CONSISTENCY = PersonalAchievementEntity(
     ...
     */
    fun getAllWeightLossAchievements(): List<PersonalAchievementEntity> = listOf(
        FIRST_KG_LOST,
        FIVE_KG_MILESTONE,
        TEN_KG_MILESTONE,
        TWENTY_KG_MILESTONE,
...
object WeightLossChallenges {
    ...
    val SEVEN_DAY_WATER = WeightLossChallenge(
        id = "7day_water",
    ...
    val FOURTEEN_DAY_CALORIE = WeightLossChallenge(
        id = "14day_calorie",
    ...
    val SUGAR_FREE_MONTH = WeightLossChallenge(
        id = "sugar_free_month",
    ...
    val MINDFUL_EATING_WEEK = WeightLossChallenge(
        id = "mindful_week",
        title = "Achtsames Essen",
    ...
    val FIVE_KG_IN_MONTH = WeightLossChallenge(
        id = "5kg_month",
    ...
    fun getAllChallenges(): List<WeightLossChallenge> = listOf(
        SEVEN_DAY_WATER,
