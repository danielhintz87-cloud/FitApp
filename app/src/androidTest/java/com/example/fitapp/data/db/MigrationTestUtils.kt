...
object MigrationTestUtils {
     ...
     */
    fun validateTableExists(db: SupportSQLiteDatabase, tableName: String) {
     ...
     */
    fun validateRowCount(db: SupportSQLiteDatabase, tableName: String, expectedCount: Int) {
     ...
     */
    fun validateDatabaseVersion(db: SupportSQLiteDatabase, expectedVersion: Int) {
        assertEquals(
            expectedVersion,
            db.version,
     ...
     */
    fun getAllIndexNames(db: SupportSQLiteDatabase, tableName: String? = null): Set<String> {
