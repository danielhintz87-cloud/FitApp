...
class DigitalCoachIntegrationTest {
    ...
    @Test
    fun testCoachingMessageGeneration() = runBlocking {
        val digitalCoach = DigitalCoachManager(context)
    ...
    @Test
    fun testPostWorkoutCoachingMessage() = runBlocking {
        val digitalCoach = DigitalCoachManager(context)
        ...
        assertEquals("Should be post-workout message", 
            CoachingMessageType.POST_WORKOUT, message.type)
        assertTrue("Post-workout messages should have high priority", 
            message.priority == CoachingPriority.HIGH)
    }
    
    @Test
    fun testCoachingTriggers() = runBlocking {
        val digitalCoach = DigitalCoachManager(context)
    ...
    @Test
    fun testFeedbackProcessing() = runBlocking {
        val digitalCoach = DigitalCoachManager(context)
