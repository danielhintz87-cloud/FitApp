...
class StreakManagerTest {
    ...
    @Test
    fun testInitialMealLogging_CreatesStreakWith1Day() = runTest {
    ...
    @Test
    fun testConsecutiveDayMealLogging_IncrementsStreak() = runTest {
    ...
    @Test
    fun testMissedDay_ResetsStreak() = runTest {
    ...
    @Test
    fun testSameDayMultipleMealLogs_DoesNotIncrementStreak() = runTest {
        val today = LocalDate.now()
    ...
    @Test
    fun testInitializeAchievements_CreatesExpectedAchievements() = runTest {
        streakManager.initializeMealLoggingAchievements()
        
        val achievements = database.personalAchievementDao()
    ...
    @Test
    fun testAchievementUnlocking_3DayStreak() = runTest {
    ...
    @Test
    fun testAchievementUnlocking_SkipsLowerThresholds() = runTest {
        // Initialize achievements first
        streakManager.initializeMealLoggingAchievements()
        ...
        val threeDayAchievement = database.personalAchievementDao()
            .getAchievementByTitle("3 Day Meal Logging Streak")
        val sevenDayAchievement = database.personalAchievementDao()
    ...
    @Test
    fun testPersistence_StreakSurvivesAppRestart() = runTest {
        val today = LocalDate.now()
    ...
    @Test
    fun testPersistence_AchievementsSurviveAppRestart() = runTest {
