...
class HydrationGoalReactivityTest {
    ...
    @Test
    fun hydrationGoal_reactiveUI_updatesWhenGoalChanges() = runTest {
    ...
    @Test
    fun hydrationGoal_reactiveUI_updatesFromDailyGoalPriority() = runTest {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val hydrationGoalUseCase = HydrationGoalUseCase.create(context)
        val userPreferencesRepository = UserPreferencesRepository(context)
    ...
    @Test
    fun hydrationGoal_reactiveUI_handlesMultipleComponents() = runTest {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val hydrationGoalUseCase = HydrationGoalUseCase.create(context)
        val userPreferencesRepository = UserPreferencesRepository(context)
