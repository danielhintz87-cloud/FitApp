...
class HydrationGoalUseCaseTest {
    ...
    @Test
    fun `getHydrationGoalMl returns daily goal when available`() =
        runTest {
    ...
    @Test
    fun `getHydrationGoalMl returns user preference when daily goal is zero`() =
        runTest {
    ...
    @Test
    fun `getHydrationGoalMl returns user preference when daily goal is null`() =
        runTest {
    ...
    @Test
    fun `getHydrationGoalMl returns user preference when no daily goal`() =
        runTest {
    ...
    @Test
    fun `getHydrationGoalMl returns default when user preference is zero`() =
        runTest {
    ...
    @Test
    fun `getHydrationGoalMl returns default when all sources unavailable`() =
        runTest {
    ...
    @Test
    fun `getTodaysHydrationGoalMl returns correct value for today`() =
        runTest {
    ...
    @Test
    fun `updateDefaultHydrationGoalMl converts ml to liters correctly`() =
        runTest {
    ...
    @Test
    fun `hydration goal priority is consistent`() =
        runTest {
