...
class MLResourceManagerTest {
    ...
    @Test
    fun `registerInterpreter should store interpreter with key`() =
        runTest {
            // Given
            ...
            // Then
            val result =
                resourceManager.useInterpreter(key) { interpreter ->
    ...
    @Test
    fun `useInterpreter should return error for unknown key`() =
        runTest {
            // Given
    ...
    @Test
    fun `useInterpreter should handle exceptions gracefully`() =
        runTest {
            // Given
            val key = "test_interpreter"
            resourceManager.registerInterpreter(key, mockInterpreter)
            ...
            // When
            val result =
                resourceManager.useInterpreter(key) {
    ...
    @Test
    fun `useInterpreter should handle OutOfMemoryError as degraded result`() =
        runTest {
            // Given
            val key = "test_interpreter"
            resourceManager.registerInterpreter(key, mockInterpreter)
    ...
    @Test
    fun `cleanup should close all interpreters`() =
        runTest {
            // Given
    ...
    @Test
    fun `isHealthy should return false after cleanup`() =
        runTest {
            // Given
