...
class PersonalAchievementManagerTest {
    ...
    @Test
    fun `should get all achievements from repository`() =
        runTest {
    ...
    @Test
    fun `should get completed achievements from repository`() =
        runTest {
    ...
    @Test
    fun `should get pending achievements from repository`() =
        runTest {
            // Given: Mock pending achievements
            val pendingAchievements =
                listOf(
                    createMockAchievement(
                        1L,
                        "Pending Achievement",
    ...
    @Test
    fun `should get achievements by category from repository`() =
        runTest {
            ...
            val achievements =
                personalAchievementManager.getAchievementsByCategory(
                    PersonalAchievementManager.CATEGORY_FITNESS,
                ).first()
            ...
            achievements.forEach { achievement ->
                assertEquals(
                    "All achievements should be fitness category",
                    PersonalAchievementManager.CATEGORY_FITNESS,
    ...
    @Test
    fun `should handle different achievement categories`() =
        runTest {
            val categories =
                listOf(
                    PersonalAchievementManager.CATEGORY_FITNESS,
    ...
    @Test
    fun `should handle empty achievement lists`() =
        runTest {
