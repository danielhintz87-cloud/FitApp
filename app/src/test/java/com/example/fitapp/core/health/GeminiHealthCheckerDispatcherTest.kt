...
class GeminiHealthCheckerDispatcherTest {
    ...
    @Test
    fun `checkHealth should not block main thread`() = runTest {
    ...
    @Test
    fun `checkHealth should be cancellable`() = runTest {
        val mockCall = mockk<Call>()
    ...
    @Test
    fun `checkHealth should handle network errors gracefully`() = runTest {
        val mockCall = mockk<Call>()
    ...
    @Test
    fun `checkHealth should fail when API key is missing`() = runTest {
    ...
    @Test
    fun `checkHealth should timeout appropriately`() = runTest {
        val mockCall = mockk<Call>()
    ...
    @Test
    fun `healthStatusFlow should use IO dispatcher`() = runTest {
        val mockCall = mockk<Call>()
        val mockResponse = mockk<Response>()
