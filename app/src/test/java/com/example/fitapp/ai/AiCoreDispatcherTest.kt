...
class AiCoreDispatcherTest {
    ...
    @Test
    fun `geminiChat should not block main thread`() = runTest {
    ...
    @Test
    fun `geminiChat should be cancellable`() = runTest {
        val mockClient = mockk<OkHttpClient>()
        val mockCall = mockk<Call>()
    ...
    @Test
    fun `perplexityChat should not block main thread`() = runTest {
        val mockClient = mockk<OkHttpClient>()
        val mockCall = mockk<Call>()
        val mockResponse = mockk<Response>()
        val mockResponseBody = mockk<ResponseBody>()
